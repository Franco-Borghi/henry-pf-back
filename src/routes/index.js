...
const { getAllMotorcycles, getMotorcycleById, getMotorcycleByName, createMotorcycles, deleteMotorcycle } = require('../controllers/Motorcycle.controller');
...
router.delete("/motorcycles/:id", deleteMotorcycle)
